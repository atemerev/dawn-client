    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} className={'loginForm'}>
                <label>
                    Bitmex API key:&nbsp;
                    <input type={'text'} value={this.state.bitmexApiKey} onChange={this.handleKeyChange}/>
                </label>
                <label>
                    API secret:&nbsp;
                    <input type={'password'} value={this.state.bitmexSecret} onChange={this.handleSecretChange}/>
                </label>
